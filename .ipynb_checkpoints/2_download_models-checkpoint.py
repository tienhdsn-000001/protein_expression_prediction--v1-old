...
#
# -- UPDATE v55.0 (AI Assistant Task) --
# - REPLACED: CodonBERT has been removed from the pipeline.
# - ADDED: Two new state-of-the-art RNA models, Rinalmo ('multimolecule/rinalmo-giga')
#   and RNA-ERNIE ('multimolecule/rnaernie'), have been added to provide a richer
#   set of RNA sequence embeddings.
...
# --- UPDATE (v55.0): New model list with Rinalmo and RNA-ERNIE ---
MODELS_TO_DOWNLOAD = {
    "dnabert_s": {
    ...
    "rinalmo": {
        ...
        "path": os.path.join(MODELS_BASE_DIR, "rinalmo_giga"),
        "type": "rna"
    },
    "rna_ernie": {
        "name": "multimolecule/rnaernie",
        "path": os.path.join(MODELS_BASE_DIR, "rna_ernie"),
        "type": "rna"
    },
    "esm2": {
        "name": "facebook/esm2_t48_15B_UR50D",
        "path": os.path.join(MODELS_BASE_DIR, "esm2_t48_15B_UR50D"),
        "type": "protein"
    }
}
